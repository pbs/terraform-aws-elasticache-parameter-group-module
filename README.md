...
```hcl
github.com/pbs/terraform-aws-elasticache-parameter-group-module?ref=0.0.6
```
...
module "elasticache_parameter_group" {
  source = "github.com/pbs/terraform-aws-elasticache-parameter-group-module?ref=0.0.6"
