...
```hcl
github.com/pbs/terraform-aws-elasticache-parameter-group-module?ref=0.0.10
```
...
module "elasticache_parameter_group" {
  source = "github.com/pbs/terraform-aws-elasticache-parameter-group-module?ref=0.0.10"
